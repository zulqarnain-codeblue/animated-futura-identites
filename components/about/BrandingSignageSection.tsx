...
const ImageReveal: React.FC<{
  ...
  const clipPaths = {
    ...
    right: { hidden: "inset(0px 0px 0px 100%)", visible: "inset(0px 0% 0px 0px)" },
    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className="mb-10 md:mb-16">
          ...
          <FadeUp delay={0.2}>
            <motion.div
              className="w-24 h-1 bg-theme mt-4"
              initial={{ scaleX: 0 }}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="relative">
              ...
              <motion.div
                className="absolute -left-14 bottom-0 w-14 bg-theme-500"
                initial={{ height: 0 }}
          ...
          >
            <div>
              ...
              <div className="flex justify-between items-end gap-3">
                ...
                {/* Right Image */}
                <FadeUp delay={0.7} className="overflow-hidden">
